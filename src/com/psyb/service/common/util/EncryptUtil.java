...
public class EncryptUtil {
	 ...
	 * @throws Exception
	 */
	public static String encodeDES(String plainText, String secretKey) throws Exception {
		Key deskey = null;
	 ...
	 * @throws Exception
	 */
	public static String decodeDES(String encryptText, String secretKey) throws Exception {
		Key deskey = null;
		DESedeKeySpec spec = new DESedeKeySpec(secretKey.getBytes());
