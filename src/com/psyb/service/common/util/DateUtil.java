...
public class DateUtil {
	...
	public static final FastDateFormat simpleDateFormat_date = FastDateFormat.getInstance("MMdd");
	...
	public static final FastDateFormat simpleDateFormat_m = FastDateFormat.getInstance("HH-mm");
	...
	public static final int DATE_M = 13;
	...
	public static String dateToStr(Date date, int type) {
		...
		case DATE_M:
			return simpleDateFormat_m.format(date);
		case DATE:
