...
public class Test {
	...
	public static void main(String[] args) throws IOException {  
		...
		JSONArray jsonArray = JSONArray.fromObject("[\"cheng\",\"123\"]");  
        for(int i=0; i < jsonArray.size(); i++)
        {
        	String index = "{" + i +"}";
        	System.out.println(" jsonArray: "+(String)jsonArray.get(i));
        }
		
//		String v = "800374$13810169874";
//		
//		System.out.println(v+ " prefix: "+StringUtil.getPrefixFromVoip(v));  
//		v = "80037400000001";
//		System.out.println(v+ " prefix: "+StringUtil.getPrefixFromVoip(v));  
//		v = "8003740000000001";
//		System.out.println(v+ " prefix: "+StringUtil.getPrefixFromVoip(v));  
...
//		
//		String bs = Base64.decodeToString(str);
//		System.out.println("\n原始压缩后的字符串为----->" + bs);  
//		System.out.println("原始压缩后的字符串长度为----->" + bs.length()); 
//
...
//		 
//		bs = Base64.decodeToString(ys);
//		System.out.println("\n压缩后的字符串为----->" + bs);  
//		System.out.println("压缩后的字符串长度为----->" + bs.length());  
//
